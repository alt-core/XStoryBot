...
class ExpressionParseTest(unittest.TestCase):
    ...
    # def test_complex_structure_parse_time(self):
    #     """元の障害シナリオに近い構造でもパース時間が実用的な範囲に収まることを確認する。"""
    #     payload = r'''{
    #       "type": "carousel",
    #       "contents": [
    #         {
    ...
    #               {
    #                 "type": "image",
    #                 "url": "https://storage.googleapis.com/example/base.jpg",
    #                 "size": "full",
    #                 "aspectMode": "cover"
    #               },
    #               {
    ...
    #                   {
    #                     "type": "image",
    #                     "url": "https://storage.googleapis.com/example/item_" + $question_id + "_1.png",
    #                     "size": "full",
    #                     "aspectMode": "cover"
    #                   }
    #                 ],
    ...
    #     expr = Expression.from_str(payload)
    #     duration = time.perf_counter() - start
    #     self.assertLess(duration, 1.5, f"Parse took too long: {duration:.3f}s")
    ...
    #     }
    #     result = expr.eval(env, [])
    #     image_url = result["contents"][0]["body"]["contents"][1]["contents"][0]["url"]
    #     self.assertEqual(
    #         image_url,
    #         "https://storage.googleapis.com/example/item_aries_1.png"
    #     )
    #     self.assertEqual(result["contents"][0]["body"]["action"]["text"], "こっちを選ぶ")
