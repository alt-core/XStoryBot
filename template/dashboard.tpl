...
<script type="text/javascript">
    ...
    function formatDateTime(timestamp) {
        ...
        // デバッグログを追加して、実際の値を確認
        console.log('formatDateTime input:', timestamp, typeof timestamp);
    ...
    function updateTaskList() {
        ...
        $.ajax({
            ...
            $('#task-list-body').html(html); // ★★★ セレクタ修正 ★★★
            ...
            $('#task-list-body').html('<tr><td colspan="6" class="text-center text-danger">タスク一覧の取得に失敗しました</td></tr>'); // ★★★ セレクタ修正 ★★★
